;(function () {
  ...
  Main.$inject = ['bio', '$timeout', '$state', 'Products', 'Votes', 'Money', 'ngDialog', '$modal']

  function Main (bio, $timeout, $state, Products, Votes, Money, ngDialog, $modal) {
    var vm = this
    ...
    vm.stateSelect = function (state) {
      console.log(state)
      bio.getReps(state)
        .then(function (response) {
          console.log('response in main2', response)
        })
    }
  }
})()
